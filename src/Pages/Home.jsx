...
const Home = () => {
    return (
        <>
            <section>
                <div id="img-Header" className="">
                    <div className="container-video">
                        <video src={backgrounvideo} autoPlay poster="" muted loop  playsInline></video>
                    </div>
                ...
                <div className="services-information">
                    <div className="information-service">
                        <div className="service-image">
                            <img src={mobileDevelopment} alt="mobileDevelopment" className="image-circle"></img>
                        </div>
